...
- **Dossier View**: Deep dive into specific entities with aggregated information from across all documents.
- **The Arena**: AI-driven debates between personas based on document context. Simulate arguments to uncover hidden insights or test hypotheses.
...
6. **The Arena**: Set up a debate between AI personas to explore different perspectives on your document data.
7. **Actions**: Review automatically generated action items and deadlines.
