...
EXTRACT_PROMPT = (
	...
	"1. **Classify & Tag**: Identify the specific document type (e.g., 'Residential Lease', 'Medical Invoice', 'Court Summons'). **DYNAMIC CATEGORY GENERATION**: Generate a specific, context-aware category based on the content (e.g., 'Real Estate', 'Healthcare', 'Legal', 'Personal Finance'). Do not be limited by generic examples. Add relevant tags.\n"
	"2. **Summarize**: Write a detailed, multi-paragraph summary.\n"
	"3. **Entities (CRITICAL)**: Extract entities with extreme precision.\n"
	"   - **People**: ONLY human names (e.g., 'John Smith'). DO NOT classify roles, departments, or generic titles as People.\n"
	"   - **Organizations**: Companies, institutions, agencies, and SPECIFIC DEPARTMENTS.\n"
	...
	"7. **ACCURACY CHECK**: Verify every extracted entity and relationship against the text. If it is not explicitly stated or strongly implied, DO NOT include it. **NO HALLUCINATIONS**.\n"
	"8. If information is missing, use null or empty arrays. Never invent.\n"
